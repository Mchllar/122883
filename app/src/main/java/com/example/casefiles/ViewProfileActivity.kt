...
class ViewProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val userResidenceTextView = findViewById<TextView>(R.id.user_residence)
        val userNationalIdTextView = findViewById<TextView>(R.id.user_national_id)
        ...
        getUserResidence(userResidenceTextView)
        getUserNationalId(userNationalIdTextView)
        ...
        user?.delete()
            ?.addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    Toast.makeText(this@ViewProfileActivity, "Account deleted successfully", Toast.LENGTH_SHORT).show()
                    ...
                    Toast.makeText(this@ViewProfileActivity, "Failed to delete account. Please try again later.", Toast.LENGTH_SHORT).show()
                }
            }
    }
        ...
        if (uid != null) {
            ...
            userRef.addValueEventListener(object : ValueEventListener {
                ...
                override fun onCancelled(databaseError: DatabaseError) {
                    ...
                    Toast.makeText(this@ViewProfileActivity, errorMessage, Toast.LENGTH_SHORT).show()
                }
            })
        }
    }

    private fun getUserResidence(userResidenceTextView: TextView) {
        ...
        if (uid != null) {
            ...
            userRef.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    if (dataSnapshot.exists()) {
                        val residence = dataSnapshot.child("residence").value.toString()
                        val residenceText = getString(R.string.user_residence_label, residence)
                        userResidenceTextView.text = residenceText
                    }
                }
    ...
    private fun getUserNationalId(userNationalIdTextView: TextView) {
        ...
        if (uid != null) {
            ...
            userRef.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    if (dataSnapshot.exists()) {
                        val nationalId = dataSnapshot.child("nationalId").value.toString()
                        val nationalIdText = getString(R.string.user_national_id_label, nationalId)
                        userNationalIdTextView.text = nationalIdText
                    }
                }
